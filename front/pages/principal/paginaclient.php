...
<body>
    <div class="cabecalho">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="..\reserva\reserva.html"><img src="..\imagens_videos\pizza_reserva.png"
                        alt=""><br> reserva</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item sair">
                <a class="nav-link" href="..\login\logout.php"><img src="..\imagens_videos\caixa_fechada_cadastro.png"
                        alt=""><br> sair</a>
            </li>
        </ul>
    </div>
